...
/**
 * Build a progress bar and update it as additional recordings begin.
 */
var create_progress_bar = function(total) {
	...
	var show_descriptor = download_count == 1 ? "1 show" : download_count + " shows";

	bar = new progress_class(show_descriptor + ' [:bar] :percent :etas', {
		complete: '=',
		incomplete: ' ',
		width: 100,
		total: total
